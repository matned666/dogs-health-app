...
public class DataChoiceListActivityEdit extends AppCompatActivity {
    ...
    private void initChipList() {
        ...
        RecyclerView.Adapter<ChipDataElementAdapter.ViewHolder> chipAdapter = new ChipDataElementAdapter(list, USAGE_EDIT, this );
    ...
    private void initOwnerList() {
        ...
        RecyclerView.Adapter<OwnerDataElementAdapter.ViewHolder> ownerAdapter = new OwnerDataElementAdapter(list, USAGE_EDIT, this );
    ...
    private void initSignsList() {
        ...
        RecyclerView.Adapter<SignDataElementAdapter.ViewHolder> signDataElementAdapter = new SignDataElementAdapter(list, USAGE_EDIT, this );
    ...
    private void initNoteList() {
        ...
        RecyclerView.Adapter<NoteDataElementAdapter.ViewHolder> noteDataElementAdapter = new NoteDataElementAdapter(list, USAGE_EDIT, this );
    ...
    private void initTattooList() {
        ...
        RecyclerView.Adapter<TattooDataElementAdapter.ViewHolder> tattooDataElementAdapter = new TattooDataElementAdapter(list, USAGE_EDIT, this );
