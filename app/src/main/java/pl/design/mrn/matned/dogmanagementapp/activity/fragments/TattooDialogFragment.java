...
public class TattooDialogFragment extends DialogFragment {
    ...
    public TattooDialogFragment(String usageFlag, Breeding breeding) {
        ...
        switch (usageFlag) {
            ...
            case USAGE_EDIT:
                ...
                ok.setOnClickListener(v -> {
                    ...
                    Objects.requireNonNull(TattooDialogFragment.this.getDialog()).hide();
                });
                break;
            case USAGE_INFO:
                ...
                ok.setOnClickListener(v -> {
                    Objects.requireNonNull(TattooDialogFragment.this.getDialog()).cancel();
                });
                break;
        }
    }
    ...
    private void getCancelButton(View root) {
        cancel = root.findViewById(R.id.cancelBreedingDialog);
        cancel.setOnClickListener(b-> Objects.requireNonNull(TattooDialogFragment.this.getDialog()).cancel());
    }
}
