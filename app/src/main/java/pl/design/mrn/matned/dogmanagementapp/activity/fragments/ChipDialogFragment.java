...
public class ChipDialogFragment extends DialogFragment {
    ...
    public ChipDialogFragment(String usageFlag, Breeding breeding) {
        ...
        switch (usageFlag) {
            ...
            case USAGE_EDIT:
                ...
                ok.setOnClickListener(v -> {
                    ...
                    Objects.requireNonNull(ChipDialogFragment.this.getDialog()).hide();
                });
                break;
            case USAGE_INFO:
                ...
                ok.setOnClickListener(v -> {
                    Objects.requireNonNull(ChipDialogFragment.this.getDialog()).cancel();
                });
                break;
        }
    }
    ...
    private void getCancelButton(View root) {
        cancel = root.findViewById(R.id.cancelBreedingDialog);
        cancel.setOnClickListener(b-> Objects.requireNonNull(ChipDialogFragment.this.getDialog()).cancel());
    }
}
